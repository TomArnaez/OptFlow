...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        std::string pathL = "basketball1.png";
        std::string pathR = "basketball2.png";
        ...
        std::cout << std::format("PathL: {}, PathR: {}", pathL, pathR) << std::endl;
        ...
        std::cout << perfPreset << " " <<  outBufGridSize << " " << hintBufGridSize << std::endl;

        Ptr<NvidiaOpticalFlow_2_0> nvof = NvidiaOpticalFlow_2_0::create(
            frameL.size(), std::vector<Rect>(), perfPreset, outBufGridSize, hintBufGridSize,
            false, false, false, gpuId);
